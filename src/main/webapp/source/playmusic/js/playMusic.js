	...
	if (username == null || username == "" || typeof (username) == "undefined") {
		...
		function createSongsingle(musicListName){
			...
			$(".menuUL2").append("<li class='menuLi2 cur'>"+"<div  class='beijing hp'"+"single2="+musicListName+">"+
					"<i class='icon isplay2'>"+"</i>"+"<a href=playList.do?type="+musicListName+" style='color:black; background-color:transparent;'>"+musicListName+"</a>"+
					"<i class='cicon dele2' single3="+musicListName+">"+"</i>"+"</div>"+"</li>");
...
//		    }
	...
	$(".start em").click(function(){
		...
		$("#audio").attr("src",'http://localhost:8080/uploadMP3/'+sid+'.mp3');
