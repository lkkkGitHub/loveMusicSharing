...
qikoo.dialog = function() {
    ...
    var r = qikoo.dialog.show({
        html: ['<form action="newSongSingle.do" method="post" id="form5">','<div class="dialog-content">', '<div class="content-title">','标题：<input type="text" name="musicListName" id="musicListName" style="height:28px;width:200px;">','</from>','</div>','</div>',
